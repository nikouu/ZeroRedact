# ZeroRedact.Benchmark.Validators.CreditCardValidatorBenchmarks
...
<div class="section-group">
    ...
    <table>
        ...
        <tbody>
            <tr><td class="method-col">ValidateCreditCardNumbers</td><td class="number-col">12.641 ns</td><td class="number-col">12.611 ns</td><td class="number-col">12.639 ns</td><td class="number-col">12.627 ns</td><td class="number-col">12.675 ns</td><td class="number-col">12.638 ns</td><td class="number-col">10.820 ns</td><td class="number-col">8.180 ns</td></tr>
        </tbody>
    </table>
</div>
...
<div class="section-group">
    ...
    <table>
        ...
        <tbody>
            <tr><td class="method-col">ValidateCreditCardNumbers</td><td class="number-col">-</td><td class="number-col">-</td><td class="number-col">-</td><td class="number-col">-</td><td class="number-col">-</td><td class="number-col">-</td><td class="number-col">-</td><td class="number-col">-</td></tr>
        </tbody>
    </table>
</div>

<script>
    const versions_ZeroRedact_Benchmark_Validators_CreditCardValidatorBenchmarks = ["2.0.0", "2.1.0", "2.2.0", "2.3.0", "2.4.0", "2.4.1", "3.0.0", "4.0.0"];
    ...
    new Chart(document.getElementById('durationChart_ZeroRedact_Benchmark_Validators_CreditCardValidatorBenchmarks'), {
        ...
        data: {
            ...
            datasets: [
            {
                ...
                data: [12.64, 12.61, 12.64, 12.63, 12.67, 12.64, 10.82, 8.18],
                borderColor: '#FF6384',
