# ZeroRedact.Benchmark.Validators.PhoneNumberValidatorBenchmarks
...
<div class="section-group">
    ...
    <div class="chart-container">
        ...
        <canvas id="durationChart_ZeroRedact_Benchmark_Validators_PhoneNumberValidatorBenchmarks"></canvas>
    </div>
    ...
    <table>
        ...
        <tbody>
            <tr><td class="method-col">ValidatePhoneNumber</td><td class="number-col">-</td><td class="number-col">-</td><td class="number-col">13.105 ns</td><td class="number-col">13.107 ns</td><td class="number-col">13.062 ns</td><td class="number-col">13.115 ns</td><td class="number-col">7.874 ns</td><td class="number-col">7.947 ns</td></tr>
        </tbody>
    </table>
</div>
...
<div class="section-group">
    ...
    <div class="chart-container">
        ...
        <canvas id="memoryChart_ZeroRedact_Benchmark_Validators_PhoneNumberValidatorBenchmarks"></canvas>
    </div>
    ...
    <table>
        ...
        <tbody>
            <tr><td class="method-col">ValidatePhoneNumber</td><td class="number-col">-</td><td class="number-col">-</td><td class="number-col">-</td><td class="number-col">-</td><td class="number-col">-</td><td class="number-col">-</td><td class="number-col">-</td><td class="number-col">-</td></tr>
        </tbody>
    </table>
</div>

<script>
    const versions_ZeroRedact_Benchmark_Validators_PhoneNumberValidatorBenchmarks = ["2.0.0", "2.1.0", "2.2.0", "2.3.0", "2.4.0", "2.4.1", "3.0.0", "4.0.0"];
    ...
    new Chart(document.getElementById('durationChart_ZeroRedact_Benchmark_Validators_PhoneNumberValidatorBenchmarks'), {
        ...
        data: {
            ...
            datasets: [
            {
                ...
                data: [null, null, 13.10, 13.11, 13.06, 13.11, 7.87, 7.95],
                borderColor: '#FF6384',
    ...
    // Memory Chart
    new Chart(document.getElementById('memoryChart_ZeroRedact_Benchmark_Validators_PhoneNumberValidatorBenchmarks'), {
        type: 'line',
        data: {
            labels: versions_ZeroRedact_Benchmark_Validators_PhoneNumberValidatorBenchmarks,
            datasets: [
